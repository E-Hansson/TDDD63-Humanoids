...
class CrudeGoalAdjusting:
    ...
    def __init__(self,direction):
        ...
        self.constant_circling_speed=-0.025
        self.slow_circling_speed=-0.0125
...
class LineUpShot:
    ...
    def start_timer(self):
        ...
        self.timer=self.current_time+40*fabs(self.first_ball_angle)/(2*pi)
        self.lost_ball_timer=self.current_time+5
    ...
    def start_turning(self):
        ...
        if self.first_ball_angle<0:
            walk.set_velocity(-0.002, -0.025, self.last_ball_angle[0])
        else:
            walk.set_velocity(-0.002, 0.025, self.last_ball_angle[0])
